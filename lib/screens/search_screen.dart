    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          //search bar is made using CupertinTextfield in AppBar using Bottom widget
                ...
                Expanded(
                  child: CupertinoTextField(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: CupertinoColors.black, width: 2.0),
                    ),
                  ),
                )
              ],
        ...
        child: Column(children: [
          ...
          const Padding(
            ...
            child: Align(
              ...
              child: Text(
                "Top Experiences on Adventurist",
                style: TextStyle(
                  fontFamily: Medium,
                  fontSize: 26,
                  color: fullblack,
          ...
          SizedBox(
            ...
            child: ListView.builder(
                // ListView.Builder for TopExperience
                scrollDirection: Axis.horizontal,
                itemCount: TopExperienceItemModeldata().topExperiences.length,
                itemBuilder: (context, index) {
                  //TopExperienceItemModel model = TopExperienceItemModeldata.getStatusItem(index);

                  return TopExperienceCards(
                      topExperience:
                          TopExperienceItemModeldata().topExperiences[index]
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                      image: NetworkImage(
                          "https://images.pexels.com/photos/14406067/pexels-photo-14406067.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"),
                      fit: BoxFit.fill),
                ),
                child: const Align(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                      image: NetworkImage(
                          "https://images.pexels.com/photos/1057840/pexels-photo-1057840.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"),
                      fit: BoxFit.fill),
                ),
                child: const Align(
                  alignment: Alignment.bottomCenter,
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage(
                      image: NetworkImage(
                          "https://images.pexels.com/photos/1823681/pexels-photo-1823681.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"),
                      fit: BoxFit.fill),
                ),
                child: const Align(
                  alignment: Alignment.bottomCenter,
